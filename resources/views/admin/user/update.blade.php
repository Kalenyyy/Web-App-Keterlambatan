...
@section('content')
    <div class="p-10 mt-10 sm:ml-64">
        ...
        <h3 class="mb-2"><a href="{{ route('dashboard') }}">Dashboard</a> / <a href="{{ route('admin.user.index') }}">Data User</a> / <span class="font-semibold">Update Data User</span></h3>

        <form class="max-w-md mx-auto mt-10 shadow-lg p-5" method="post" action="{{ route('admin.user.update', $user['id']) }}">
            <h1 class="text-center text-2xl mb-10 font-semibold">Form Update Data User</h1>

            @csrf
            @method('PATCH')
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="name" id="floating_email" value="{{ $user['name'] }}"
