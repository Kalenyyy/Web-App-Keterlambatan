...
<div class="p-10 mt-10 sm:ml-64">
    ...
    <h3 class="mb-2"><a href="{{ route('dashboard') }}">Dashboard</a> / <span class="font-semibold">Data User</span></h3>
    ...
    <div class="overflow-x-auto">
        <div class="p-2 mt-2 text-lg font-semibold text-white bg-white dark:text-white dark:bg-gray-800">
            <a href="{{ route('admin.user.create') }}"
                class="px-5 py-2.5 transition-all ease-in duration-75 bg-[#222] dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Tambah User
            </a>
        </div>
