...
@section('content')
    <div class="p-10 mt-10 sm:ml-64">
        <div class="container mx-auto p-4">
            ...
            <h3 class="mb-2 font-base"><a href="{{ route('dashboard') }}">Dashboard</a> / <span class="font-semibold">Data Rombel</span></h3>
                ...
                <form class="pb-4 p-5 bg-white dark:bg-gray-900 flex flex-wrap" method="get" action="{{ route('admin.rombel.index') }}">
                    <div class="relative mt-1 w-full sm:w-1/2 lg:w-1/5">
                        <input type="text" name="search"
                            class="block pt-2 ps-15 text-sm text-gray-900 border border-gray-300 rounded-lg w-full sm:w-auto bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Search Rombel">
                    </div>
                        ...
                        <tbody>
                            @foreach ($rombels as $rombel)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-center sm:text-center w-10">
                                        ...
                                        <form action="{{ route('admin.rombel.delete', $rombel['id']) }}" method="post">
                                            ...
                                            <button class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                onclick="return confirm('Apakah Yakin Hapus Data Rombel?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
