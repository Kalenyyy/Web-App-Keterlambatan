...
<div class="p-10 mt-10 sm:ml-64">
    <h1 class="text-2xl mb-1 font-bold">Update Data Rayon</h1>
        <h3 class="mb-2"><a href="{{ route('dashboard') }}">Dashboard</a> / <a href="{{ route('admin.rayon.index') }}">Data Rayon</a> / <span class="font-semibold">Update Data Rayon</span></h3>
    <form class="max-w-md mx-auto mt-12 shadow-lg p-5" method="post" action="{{ route('admin.rayon.update', $rayons['id']) }}">
        <h1 class="text-center text-2xl mb-10 font-semibold">Form Update Rayon</h1>
            @csrf
        @csrf
        @method('PATCH')
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="rayon" id="rayon" value="{{ $rayons['rayon'] }}"
