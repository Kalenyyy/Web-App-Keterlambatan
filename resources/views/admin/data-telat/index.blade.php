                                    ...
                                    <tbody>
                                        @foreach ($lates as $data)
                                            <tr class="border-b dark:border-gray-700 text-left">
                                                ...
                                                <td class="px-4 py-3">{{ $data['date_time_late'] }}</td>
                                                <td class="px-4 py-3">{{ $data['information'] }}</td>
                                                <td class="px-6 py-4 flex">
                                                    <a href="{{ route('admin.data-telat.edit', $data['id']) }}"
                                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit
                                                        |</a>
                                                    <form action="{{ route('admin.data-telat.destroy', $data['id']) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            class="ml-1 font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                            onclick="return confirm('Apakah Yakin Hapus Data Rombel?')"
                                        ...
                                        @foreach ($lates as $data)
                                            @if ($data['student']['name'] != $namaSebelumnya)
                                                <tr class="border-b dark:border-gray-700 text-center">
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('admin.data-telat.show', ['student_id' => $data->student_id]) }}">Detail</a>
                                                    </td>
                                                    <th scope="row"
                                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
