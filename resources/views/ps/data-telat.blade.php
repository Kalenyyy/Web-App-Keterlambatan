...
@section('content')
    <div class="p-10 mt-10 sm:ml-64">
        <h1 class="text-2xl mb-1 font-bold">Data Keterlambatan {{ Auth::user()->name }}</h1>
            ...
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab" data-tabs-target="#profile"
                        type="button" role="tab" aria-controls="profile" aria-selected="false">Keseluruhan
                        Data</button>
                </li>
                <li class="me-2" role="presentation">
                    <button
                        ...
                        aria-controls="dashboard" aria-selected="false">Rekapitulasi Data</button>
                </li>
            </ul>
        </div>
                            ...
                            @unless (in_array($student['student']['name'], $uniqueNames))
                                <tr class="border-b dark:border-gray-700 text-center">
                                    ...
                                    <td class="px-4 py-3"><a
                                            href="{{ route('detailStudent', $student->student_id) }}">Show</a></td>
                                    <td class="px-4 py-3">
